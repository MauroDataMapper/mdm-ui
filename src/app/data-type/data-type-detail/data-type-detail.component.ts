...
export class DataTypeDetailComponent implements OnInit {
  ...
  save() {
    ...
    this.resources.dataType
      .update(this.mcParentDataModel.id, this.dataType.id, resource)
      .subscribe(
  ...
  delete() {
    this.resources.dataType
      .remove(this.mcParentDataModel.id, this.dataType.id)
      .subscribe(
        () => {
  ...
  askToDelete() {
    ...
    this.resources.dataElement
      .listWithDataType(this.mcParentDataModel.id, this.dataType.id)
      .subscribe((res) => {
