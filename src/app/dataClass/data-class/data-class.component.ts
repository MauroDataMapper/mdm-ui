...
export class DataClassComponent implements OnInit {
  ...
  async  ngOnInit() {
    ...
    this.afterSave = (result: {body: {id: any;};}) => this.dataClassDetails(this.stateService.params.dataModelId,this.parentDataClass.id,result.body.id);
  }
  ...
  dataClassDetails(dataModelId: any, parentDataClassId,id) {
    this.resourcesService.dataClass.get(dataModelId, parentDataClassId, id, null, null).subscribe((result: { body: DataClassResult; }) => {
