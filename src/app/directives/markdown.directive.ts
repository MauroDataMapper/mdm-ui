...
export class MarkdownDirective implements OnInit {
    ...
    constructor(private markdownParser: MarkdownParserService, private el: ElementRef, private renderer: Renderer2) {
    }
    ...
    {
        if (this.markdown) {
            var html = this.markdownParser.parse(this.markdown, this.renderType);
