...
import { Component, OnInit, AfterViewInit, Input, EventEmitter, Output, Inject, ViewChildren, QueryList, ViewChild, ContentChildren } from '@angular/core';
...
export class FolderDetailComponent implements OnInit, AfterViewInit {
    ...
    formBeforeSave = function() {
        ...
        if (this.validateLabel(this.result.label)) {
            ...
            this.resourcesService.folder.put(resource.id, null, { resource }).subscribe(result => {
                if (this.afterSave) {
