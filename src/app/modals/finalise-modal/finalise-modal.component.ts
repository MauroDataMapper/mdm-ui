...
export class FinaliseModalComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    if (nameSplit.length === 3) {
      ...
      this.versionMinor = 'Example: 1.0.0  <span class="fas fa-long-arrow-alt-right"></span>  1.<strong>1</strong>.0';
      this.versionPatch = 'Example: 1.0.0  <span class="fas fa-long-arrow-alt-right"></span>  1.0.<strong>1</strong>';
    }
  }
