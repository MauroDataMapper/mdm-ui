...
export class StateHandlerService {
    ...
    handleSimpleView(name, params) {
        ...
        var index = needsRedirect.findIndex((item) => {
    ...
    getURL(name, params = {}): string {
        var state = this.getStateName(name, params);
    ...
    NewWindow (name, params = {}, windowsOptions = null) {
        var url = this.router.stateService.href(this.getStateName(name,  params),params);
