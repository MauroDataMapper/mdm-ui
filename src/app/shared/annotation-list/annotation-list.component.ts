...
export class AnnotationListComponent implements AfterViewInit {
        ...
        merge(this.sort.sortChange, this.paginator.page, this.reloadEvent)
            .pipe(
                ...
                switchMap(() => {
                    ...
                    return this.annotationFetch(this.paginator.pageSize,
    ...
    saveParent = (record, index) => {
        ...
        this.resources.facets
            .post(this.parent.id, 'annotations', { resource }).subscribe(result => {
    ...
    addChild = (annotation) => {
        ...
        this.resources.facets
            .post(this.parent.id, 'annotations/' + annotation.id + '/annotations', { resource }).toPromise()
            .then(
                (response) => {
