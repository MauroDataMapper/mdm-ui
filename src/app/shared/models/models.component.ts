...
export class ModelsComponent implements OnInit {
    ...
    constructor(private sharedService : SharedService, private validator: ValidatorService, private folderHandler: FolderHandlerService, private stateHandler: StateHandlerService, private resources: ResourcesService, private title: Title, private securityHandler: SecurityHandlerService,private broadcastSvc: BroadcastService, private userSettingsHandler: UserSettingsHandlerService) { }
    ...
    ngOnInit() {
        ...
        if (this.sharedService.searchCriteria && this.sharedService.searchCriteria.length > 0) {
    ...
    tabSelected = (tabIndex) => {
        switch (tabIndex) {
            case 0: { return this.currentTab = "models"; }
            case 1: { return this.currentTab = "classifications"; }
            case 2: { return this.currentTab = "favourites" }
            default: { this.currentTab = "models" }
        }
    };
