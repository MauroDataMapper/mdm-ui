import { Component, Input, ViewChild, ViewChildren, QueryList, EventEmitter, AfterViewInit, ChangeDetectorRef } from '@angular/core';
...
export class SummaryMetadataTableComponent implements AfterViewInit {
    ...
    constructor(private changeRef: ChangeDetectorRef, private resources: ResourcesService) { }
        ...
        merge(this.sort.sortChange, this.paginator.page, this.filterEvent)
            .pipe(
                ...
                switchMap(() => {
                    ...
                    return this.summaryMetadataFetch(this.paginator.pageSize,
                    ...
                    data.body['items'].forEach(
                        (item) => {
                            if (item.summaryMetadataType && item.summaryMetadataType.toLowerCase() === 'map') {
                                ...
                                item.summaryMetadataReports.forEach(
                                    (report) => {
