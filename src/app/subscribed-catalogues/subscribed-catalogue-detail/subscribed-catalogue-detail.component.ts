...
import { EditableSubscribedCatalogue, SubscribedCatalogue } from '@mdm/model/subscribed-catalogue-model';
...
export class SubscribedCatalogueDetailComponent implements OnInit {
  ...
  editableForm: EditableSubscribedCatalogue;
  ...
  ngOnInit(): void {     
    ...
    this.editableForm = new EditableSubscribedCatalogue(this.subscribedCatalogue);

    this.editableForm.onCancel.subscribe(() => {
