import {Component, OnInit, ViewChild, Inject, forwardRef, ChangeDetectorRef} from '@angular/core';
...
export class TermComponent implements OnInit {
  ...
  constructor(private resources: ResourcesService, private messageService: MessageService, private sharedService: SharedService, private stateService: StateService, private stateHandler: StateHandlerService, private broadcast : BroadcastService, private changeRef: ChangeDetectorRef) {
...
{
  var terms = [];
  terms.push(this.resources.terminology.get(this.stateService.params.terminologyId, null));
  terms.push(this.resources.term.get(this.stateService.params.terminologyId, this.stateService.params.id, null));
  terms.push(this.resources.term.get(this.stateService.params.terminologyId, this.stateService.params.id, "semanticLinks"));
 ...
 // this.tabGroup.realignInkBar();
  ...
  getTabDetailByIndex(index) {
    switch (index) {
      ...
      case 0: return { index: 0, name: 'properties' };
      case 1: return { index: 1, name: 'comments' };
      case 2: return { index: 2, name: 'links' };
      case 3: return { index: 3, name: 'attachments' };
      default: return { index: 0, name: 'properties' };
    }
  }
  ...
  tabSelected(index) {
    ...
    this.stateHandler.Go("term", { tabView: tab.name }, { notify: false, location: tab.index != 0 });
