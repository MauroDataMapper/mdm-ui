...
export class TerminologyDetailsComponent implements OnInit {
    ...
    constructor(private sharedService: SharedService, private helpDialogueHandler: HelpDialogueHandlerService, private dialog: MatDialog, private messageHandler: MessageHandlerService, private stateHandler: StateHandlerService, private resources: ResourcesService, private exportHandler: ExportHandlerService, private securityHandler: SecurityHandlerService, private broadcastSvc: BroadcastService) { }
    ...
    ngOnInit() {
        ...
        let access: any = this.securityHandler.elementAccess(this.mcTerminology);
    ...
    export = (exporter) => {
        ...
        this.exportHandler.exportDataModel([this.mcTerminology], exporter).subscribe((res) => {
            ...
            let aLink = this.exportHandler.createBlobLink(result.fileBlob, result.fileName);
    ...
    delete = (permanent?) => {
        ...
        this.resources.terminology.delete(this.mcTerminology.id, null, queryString)
            .subscribe(() => {
                ...
                this.broadcastSvc.broadcast('$elementDeleted', () => {this.mcTerminology, permanent;});
            }, (error) => {
    ...
    loadExporterList = () => {
        ...
        this.securityHandler.isValidSession().subscribe((result) => {
            ...
            this.resources.public.dataModelExporterPlugins().subscribe((result) => {
