import { Component, OnInit, Input, ViewChild, Output, Query, QueryList, ElementRef, EventEmitter } from '@angular/core';
...
export class MarkdownTextAreaComponent implements OnInit {
    ...
    @ViewChild('editableTextArea', { static: false }) editableTextArea: ElementRef;
    ...
    constructor(private markdownParser: MarkdownParserService, private elementDialogueService: ElementSelectorDialogueService, private messageService: MessageService) {
    ...
    public elementSelected() {
        ...
        this.messageService.elementSelector.subscribe(data => {
            ...
            if (this.selectedElement != null) {
                let markdownLink = this.markdownParser.createMarkdownLink(this.selectedElement);
                if (this.editableTextArea) {
                    let startPos = this.editableTextArea.nativeElement.selectionStart;
