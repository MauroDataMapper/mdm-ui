...
export class TermRelationshipsComponent implements OnInit {
  ...
  relationshipTypes = [];
  relations = [];
  constructor(private resources: ResourcesService, private helpDialogueService: HelpDialogueHandlerService, private dialog: MatDialog, private messageService: MessageService) {
  ...
  public loadHelp() {
    this.helpDialogueService.open("Editing_properties", { my: "right top", at: "bottom"} as DialogPosition);
  }
