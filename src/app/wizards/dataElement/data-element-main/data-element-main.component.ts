...
constructor(private stateService: StateService, private stateHandler: StateHandlerService, private resources: ResourcesService, private messageHandler: MessageHandlerService,private changeRef: ChangeDetectorRef ) { }
  ...
  saveNewDataElement = () => {
    ...
    if(!this.model.showNewInlineDataType){
      //dataType = {id: this.result.dataType.id}; TODO
    }else{
      var res = {
      ...
      var deferred = this.resources.dataModel.post(this.parentDataModelId, 'dataTypes', { resource: res });
    ...
    var deferred;
      deferred = this.resources.dataClass.post(this.parentDataModelId, this.parentDataClassId, "dataElements", { resource: resource });
  ...
  saveNewDataType = () => {
    ...
    var deferred = this.resources.dataModel.post(this.parentDataModelId, 'dataTypes', { resource: resource });
