angular.module('controllers').controller('dataModelCtrl', function ($scope, $state, $stateParams, resources,$window, selectionHandler, ngToast, $rootScope, jointDiagramService3, $q, elementTypes, stateHandler) {
