angular.module('controllers').controller('terminologyCtrl',  function ($scope, $state, $stateParams, resources, $window, $rootScope, jointDiagramService3, $q, elementTypes, stateHandler) {
